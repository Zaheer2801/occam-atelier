...
const items = [
  { t: "Dashboard", url: "/app/client/dashboard", icon: LayoutDashboard },
  { t: "Applications", url: "/app/client/applications", icon: Briefcase },
  { t: "Analytics", url: "/app/client/analytics", icon: BarChart3 },
  { t: "Profile", url: "/app/client/profile", icon: User },
];
