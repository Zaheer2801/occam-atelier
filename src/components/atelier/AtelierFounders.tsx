  ...
  <section className="container max-w-7xl py-20">
    <div className="grid md:grid-cols-[1.1fr_1fr] gap-10 items-start">
      <div>
        ...
        <p className="mt-5 max-w-lg text-[hsl(30_10%_25%)] leading-relaxed">
          Job searching is broken on the candidate side. You spend 6–8 hours a day sending
          applications into silence — too exhausted to prepare for the interviews that matter.
          Narendra and Zaheer built OCAS in 2022 to fix that. Not with another job board. With
          a team that does the work for you.
        </p>
      </div>
      <div className="space-y-5">
        {founders.map((f) => (
          <div
            key={f.name}
            className="atelier-card-cream p-6 flex items-center gap-5 border-l-[3px] border-[hsl(8_84%_55%)]"
          >
            <div className="h-14 w-14 rounded-full bg-[hsl(46_96%_58%)] grid place-items-center atelier-display text-2xl font-extrabold text-[hsl(8_84%_55%)]">
              {f.initial}
            </div>
            <div>
